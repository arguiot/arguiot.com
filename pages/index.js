    ...
    return <React.Fragment>
        ...
        <header className={styles.header} >
            ...
            <p className={styles.text} ref={text}>
                I'm a computer science student at <a href="https://scu.edu" target='_blank' style={{ color: "inherit" }}>Santa Clara University</a>. I'm a passionate programmer, and I love to build things and share them with the world. Have fun learning about me and my projects!
            </p>
