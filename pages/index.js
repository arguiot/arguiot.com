    ...
    <React.Fragment>
      ...
      <header className={styles.header}>
        ...
        <p className={styles.text} ref={text}>
          ...
          . I'm a passionate programmer, and I love to build things and share
          them with the world. Have fun learning about me and my projects!
        </p>
      ...
      <div className={styles.layout}>
        ...
        <Text h1>Say Hi!</Text>
        <Text h3>
          Shoot me an email, reach out on social media, or send a carrier
          pigeon. Regardless of how, I’d love to get in touch.
        </Text>
        <Spacer h={3} />
        <Grid.Container gap={2}>
          ...
          <Grid xs={24} md={8}>
            <Card>
              ...
              <Description
                ...
                content={
                  <>
                    <Link href="/resume.pdf" color underline>
                      English
                    </Link>{" "}
                    |{" "}
                    <Link href="/resume-fr.pdf" color underline>
                      French
                    </Link>
                  </>
                }
          ...
          <Grid xs={24} md={8}>
            <Card>
              ...
              <Description
                title="Ethereum Adress"
                content={
                  <Tooltip text="Ethereum Mainnet & Polygon compatible">
                    <Link
                      href="https://etherscan.io/address/0xD34FDA64241a3D3ba71041AC4BbFc188d795BF15"
                      color
                      underline
                      target="_blank"
                    >
